...
import com.example.connectionsmanagement.ConnectionsMap.ImageDownloader.stringToIntArray
...
class ShowCommunicationActivity : AppCompatActivity() , ShowCommunicationsAdapter.onDeleteButtonClickListener{
