...
class EditRelationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val phone_ET=findViewById<EditText>(R.id.editRelationName_EditText)
        val email_ET=findViewById<EditText>(R.id.editRelationName_EditText)
        val notes_ET=findViewById<EditText>(R.id.editRelationName_EditText)
                    ...
                    if (responseBody != null) {
                        ...
                        runOnUiThread {
                            ...
                            if(jsonObject["result"].asString=="success"){
                                Toast.makeText(ConnectionsManagementApplication.context,"修改关系成功",
                                    Toast.LENGTH_SHORT).show()
                                ConnectionsManagementApplication.IsRelationsChanged=true
                            }else{
                                Toast.makeText(ConnectionsManagementApplication.context,"修改关系失败",
                                    Toast.LENGTH_SHORT).show()
                            }
                            finish()
                        }
