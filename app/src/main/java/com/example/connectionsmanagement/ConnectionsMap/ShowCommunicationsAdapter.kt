...
class ShowCommunicationsAdapter(private val context: Context, private val shows: List<ShowCommunication>, private val listener: ShowCommunicationsAdapter.onDeleteButtonClickListener) : RecyclerView.Adapter<ShowCommunicationsAdapter.ViewHolder>()  {
