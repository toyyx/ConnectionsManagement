...
import com.example.connectionsmanagement.ConnectionsMap.ConnectionsManagementApplication.Companion.context
...
class CardPersonAdapter(private val context: Context, private val results: List<Relation>, private val listener: CardPersonAdapter.onDeleteButtonClickListener) : RecyclerView.Adapter<CardPersonAdapter.ViewHolder>() {
